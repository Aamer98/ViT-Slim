...
class Block(nn.Module):
    ...
    def __init__(self, 
        ...
        if self.has_attention:
            ...
            self.attn = Attention(
                dim, num_heads=num_heads, head_size=dim//num_heads, qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop, proj_drop=drop)
